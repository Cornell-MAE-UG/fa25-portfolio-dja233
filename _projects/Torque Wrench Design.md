...
![Shaded rendering of earlier version]({{"assets/images/Screenshot-Granta_software.png" | relative_url }}){:.inline-image-r style="height: 200px"}
...
![Shaded rendering of earlier version]({{"assets/images/boundary-conditions-diagram.jpg" | relative_url }}){:.inline-image-r style="height: 200px"}

Below is an image showing the location of the strain gauge:
![Shaded rendering of earlier version]({{"assets/images/strain-gauge-location-on-torque-wrench.png" | relative_url }}){:.inline-image-r style="height:200px"}

Normal Strain Contours:
![Shaded rendering of earlier version]({{"assets/images/Normal-strain-contours.png" | relative_url }}){:.inline-image-r style="height:200px"}

Maximum Principal Stress Contours:
![Shaded rendering of earlier version]({{"assets/images/principal-stress-contours.png" | relative_url }}){:.inline-image-r style="height:200px"}
